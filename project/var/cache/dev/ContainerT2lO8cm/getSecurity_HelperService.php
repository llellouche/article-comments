...
class getSecurity_HelperService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        ]), ['dev' => NULL, 'api' => new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Security\\ApiAuthenticator' => ['privates', 'App\\Security\\ApiAuthenticator', 'getApiAuthenticatorService', true],
        ], [
            'App\\Security\\ApiAuthenticator' => '?',
        ]), 'public' => new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
